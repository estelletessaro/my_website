...
knitr::include_graphics("/img/blogs/estelle.jpg", error=FALSE) 
```

I also love other things though. First of all, I love to hang out with my friends and loved ones.

```{r picture2, echo=FALSE, out.width="25%"}
knitr::include_graphics("/img/blogs/aboutme2.jpeg", error=FALSE) 
knitr::include_graphics("/img/blogs/aboutme3.jpeg", error=FALSE) 
knitr::include_graphics("/img/blogs/aboutme4.jpeg", error=FALSE) 
knitr::include_graphics("/img/blogs/aboutme5.jpeg", error=FALSE) 
```
