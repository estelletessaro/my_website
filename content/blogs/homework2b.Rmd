...
description: TfL releases data on how many bikes were hired every single day. Let's look at monthly bike hires over the years.
draft: no
...
```{r tfl_absolute_monthly_change, echo=TRUE, out.width="100%"}
...
```{r tfl_percent_change, echo=TRUE, out.width="100%"}
