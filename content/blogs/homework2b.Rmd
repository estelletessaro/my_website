...
```{r picture5, echo=FALSE, out.width="60%"}
knitr::include_graphics("/img/blogs/tfl_monthly.png", error=FALSE) 
```
...
```{r picture6, echo=FALSE, out.width="60%"}
knitr::include_graphics("/img/blogs/tfl_weekly.png", error=FALSE) 
```
